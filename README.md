...
> Note: This workflow currently uses `npm install` so it works even when no lockfile is committed.
> If you add `package-lock.json`, you can switch back to `npm ci` for stricter reproducible installs.
